...
#         bap2ap( "$apgendir/$base.bap", "$gendir/$base.ap" );
	 ...
	 shell("$cmd");
      ...
      shell("rm -f $gendir/$base.p_mgc $gendir/$base.mgc_delta.var $gendir/$base.mgc_delta $gendir/$base.mgc_pdf");
      shell("rm -f $gendir/$base.f0");
      shell("rm -f $gendir/$base.lf0_ip $gendir/$base.lf0_delta.var $gendir/$base.lf0_delta $gendir/$base.lf0_pdf");
