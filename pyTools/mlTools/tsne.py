...
if __name__ == "__main__":
    ...
    #X = Math.loadtxt("list3/we_ori_tune.txt");
    #labels = Math.loadtxt("list3/we_label.txt");
    #Y = tsne(X, 2, 50, 20.0);
    #Plot.scatter(Y[:,0], Y[:,1], 20, labels);
    #py_rw.write_raw_mat(Y,'list3/we_ori_tune_tsne.mat')
    #X = Math.loadtxt("list3/we_post1_tune.txt");
    #labels = Math.loadtxt("list3/we_label.txt");
    #Y = tsne(X, 2, 50, 20.0);
    #Plot.scatter(Y[:,0], Y[:,1], 20, labels);
    #py_rw.write_raw_mat(Y,'list3/we_post1_tune_tsne.mat')
    #pass
