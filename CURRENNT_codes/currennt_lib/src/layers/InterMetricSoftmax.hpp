...
#ifndef LAYERS_INTERMETRIC_SOFTMAX_HPP
#define LAYERS_INTERMETRIC_SOFTMAX_HPP
...
namespace layers {
    ...
    class InterMetricLayer_softmax : public InterMetricLayer<TDevice>
    {
	...
	// Destructor
	virtual ~InterMetricLayer_softmax();
